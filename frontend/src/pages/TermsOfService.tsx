  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 font-sans text-gray-800">
      ...
      <div className="space-y-8 leading-relaxed">
        <section>
          <p className="mb-4">
            This website is operated by <strong>BGFIT</strong>. Throughout the
            site, the terms “we”, “us” and “our” refer to <strong>BGFIT</strong>
            . <strong>BGFIT</strong> offers this website, including all
        ...
        <section>
          <h2 className="text-xl font-bold uppercase tracking-wide mb-4 text-gray-900 border-b pb-2">
        ...
        <section>
          ...
          <p>
            In no case shall <strong>BGFIT</strong>, our directors, officers,
        ...
        <section>
          ...
          <p>
            ...
            <strong>BGFIT</strong> and our parent, subsidiaries, affiliates,
        ...
        <section className="bg-gray-50 p-6 rounded-lg mt-12 border border-gray-100">
          <h2 className="text-xl font-bold uppercase tracking-wide mb-4 text-gray-900">
            Section 20 - Contact Information
          </h2>
          <p>
            Questions about the Terms of Service should be sent to us at{" "}
            <a
              href="mailto:support@bgfit.in"
