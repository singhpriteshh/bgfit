    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 font-sans text-gray-800">
      ...
      <div className="space-y-8 leading-relaxed">
        ...
        <section>
          ...
          <h3 className="font-bold mb-2">How do you get my consent?</h3>
          <p className="mb-4">
          ...
          <h3 className="font-bold mb-2">How do I withdraw my consent?</h3>
          <p>
        ...
        <section className="bg-gray-50 p-6 rounded-lg mt-12 border border-gray-100">
          ...
          <div className="mt-4 text-gray-700 bg-white p-4 border rounded shadow-sm inline-block">
            <strong>BGFIT Store</strong>
            <br />
            TB Road, Mahesana - 384002
            <br />
            Gujarat, India
